...
describe("tokens", () => {
	...
	it("JS_EASINGS.out/in are easing.ts's expoOut/expoIn (boundary sanity, not curve-shape testing)", () => {
		expect(JS_EASINGS.out).toBe(expoOut);
		expect(JS_EASINGS.in).toBe(expoIn);
