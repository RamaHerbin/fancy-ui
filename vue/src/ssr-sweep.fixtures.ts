...
export const PROVIDER_ONLY: ReadonlySet<string> = new Set([
	...
	"root:PopoverContent",
	"root:ContextMenuTrigger",
	"root:ContextMenuContent",
	"root:ContextMenuItem",
	"root:ContextMenuSub",
	"root:ContextMenuSubTrigger",
	"root:ContextMenuSubContent",
]);
...
export const fixtures: Record<string, Record<string, unknown>> = {
	...
	"root:ArtifactCard": {"title":"Q3 revenue memo","kind":"Memo","version":2,"versionCount":5,"status":"streaming","preview":"The quarter closed ahead of plan."},
	...
	"root:ChatMessageAction": {"label":"Copy"},
	"root:ChatMessageBranches": {"index":2,"count":3},
	...
	"root:Composer": {"placeholder":"Message…"},
	"root:ComposerAttachment": {"attachment":{"id":"a1","name":"notes.pdf","size":2048,"status":"uploading","progress":0.4}},
	"root:ComposerAttachments": {"addLabel":"Attach files","multiple":true},
	"root:ComposerCommandMenu": {"trigger":"/","items":[{"id":"deploy","label":"/deploy","description":"Ship the current branch","hint":"⌘⏎"},{"id":"reset","label":"/reset","description":"Clear the conversation"}],"label":"Commands"},
	"root:ComposerInput": {"placeholder":"Message…","rows":1,"maxRows":8},
	"root:ComposerModelPicker": {"models":[{"id":"mini","label":"Mini","badge":"Fast","description":"Short answers, small context."},{"id":"pro","label":"Pro","description":"Deeper reasoning, slower."}],"value":"mini","label":"Model"},
	"root:Confetti": {"manualStart":true},
	"root:ContextRing": {"usage":{"used":12400,"max":200000}},
	"root:CopyButton": {"value":"npm install fancy-ui-vue"},
	...
	"root:InlineCitation": {"source":{"id":"s1","title":"Designing citation surfaces","url":"https://docs.example.dev/citations","domain":"docs.example.dev","snippet":"A citation is a promise that the answer can be checked."},"index":1},
