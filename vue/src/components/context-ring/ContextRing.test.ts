...
function meter(container: Element): HTMLElement {
	return container.querySelector('[role="meter"]') as HTMLElement;
}

function arc(container: Element): SVGCircleElement {
	return container.querySelector(".ft-ctxring-value") as SVGCircleElement;
}

function trigger(container: Element): HTMLButtonElement | null {
	return container.querySelector(".ft-ctxring-trigger");
}

function panel(container: Element): HTMLElement | null {
	return container.querySelector(".ft-ctxring-panel");
}

function labelText(container: Element): string {
...
function drawn(container: Element): number {
