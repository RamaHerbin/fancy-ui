...
describe("LiquidText", () => {
	...
	describe("WebGL unavailable fallback", () => {
		it("renders visible styled fallback text, starts no rAF render loop, and logs no console errors", async () => {
	...
	describe("prefers-reduced-motion fallback", () => {
		it("renders static fallback text and starts no rAF render loop when reduced motion is preferred", async () => {
