...
export type { BookProps } from "./Book.vue";
export { default as BookHeader } from "./BookHeader.vue";
export type { BookHeaderProps } from "./BookHeader.vue";
export { default as BookTitle } from "./BookTitle.vue";
export type { BookTitleProps } from "./BookTitle.vue";
export { default as BookDescription } from "./BookDescription.vue";
export type { BookDescriptionProps } from "./BookDescription.vue";
