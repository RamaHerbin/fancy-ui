// Transposed 1:1 from the Svelte suite: same describes, same cases, same
// assertions. The only edits are non-null assertions on array/typed-array
// index reads, which this package's `noUncheckedIndexedAccess` requires and
// the Svelte root tsconfig does not.
