...
import FireworksHdr from "./FireworksHdr.vue";
...
describe("FireworksHdr", () => {
	...
	it("re-exports the figure helpers consumers are told to import", async () => {
		// The package barrel re-exports `./fireworks-hdr/index.js`, so what this
		// module exposes is exactly what `import { … } from "fancy-ui-vue"` can
		// reach.
