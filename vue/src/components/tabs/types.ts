 ...
 * and `TabsContent` read both through injected context instead of a prop and
 * a callback threaded down by hand for each of them.
 *
...
export const TABS_KEY: InternalContext<TabsContext> = createInternalContext<TabsContext>(
	"TabsContext"
);
