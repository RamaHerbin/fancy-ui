...
// PointerEvent constructor, unlike the Svelte package's jsdom (^28.0.0) that
// this test was copied from verbatim. Local polyfill only, no behavior change
// where PointerEvent already exists.
