...
All notable changes to fancy-ui will be documented here.

## [0.0.1] - 2026-03-13

Initial public release — 50 components across 10 categories.

### Highlights

- Built with **Svelte 5 runes** (`$state`, `$derived`, `$effect`) throughout
- Styled with **Tailwind CSS v4** and dark mode support out of the box
- Zero config required — copy a component, drop it in, done
- **MIT licensed**
