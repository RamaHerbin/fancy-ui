...
- `src/routes/demo/`  
  Demo pages showcasing each implemented component
...
2. Ensure the required component(s) are already implemented
3. Reimplement in Svelte:
...
2. Ensure required components are implemented
3. Reimplement in Svelte:
...
- Keep prop names consistent with reference design when reasonable
...
Each implemented component MUST have a demo page at `src/routes/demo/[component]/+page.svelte`.
...
The home page should serve as an index of all implemented components:
- List all available components with links to `/demo/[component]`
- Show implementation status (done, in progress, planned)
- Group by category if needed

## Testing Strategy

### Validation Checklist
- [ ] Visual parity with reference design
...
Based on complexity and utility, suggested implementing order:
