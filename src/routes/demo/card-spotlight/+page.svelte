...
<svelte:head>
	<title>Card Spotlight - FancyUI</title>
</svelte:head>

<div class="container mx-auto py-12 px-4">
	<h1 class="text-3xl font-bold mb-2">Card Spotlight</h1>
	<p class="text-muted-foreground mb-8">
		Card with a mouse-following spotlight gradient effect on hover.
	</p>

	<!-- Basic Example -->
	<section class="mb-12">
		<h2 class="text-xl font-semibold mb-4">Basic Usage</h2>
		<div class="flex flex-wrap gap-6 justify-center border rounded-lg p-6 bg-card">
