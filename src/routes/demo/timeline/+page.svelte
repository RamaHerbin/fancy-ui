...
<!-- Full-width timeline -->
<Timeline {items} title="Changelog" description="A history of updates and milestones.">
			...
			<div class="space-y-4">
				...
				<div class="bg-card rounded-lg border p-4">
					...
					<p class="text-muted-foreground text-sm">
						Launched FancyUI with 12+ ported components including AnimatedBeam, Compare,
						DirectionAwareHover, and more.
					</p>
				</div>
				<div class="bg-card rounded-lg border p-4">
		...
		{:else if item.id === "late-2024"}
			<div class="space-y-4">
				...
				<div class="bg-card rounded-lg border p-4">
					...
					<p class="text-muted-foreground text-sm">
						Started porting FancyUI components from Vue to idiomatic Svelte 5. Established component
