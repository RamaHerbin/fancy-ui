...
<div class="container mx-auto px-4 py-12">
	<h1 class="mb-2 text-3xl font-bold">FlipCard</h1>
	...
	<!-- Basic Example -->
	<section class="mb-12">
		<h2 class="mb-4 text-xl font-semibold">Basic Usage (Y-axis)</h2>
	...
	<!-- X-axis rotation -->
	<section class="mb-12">
		<h2 class="mb-4 text-xl font-semibold">X-axis Rotation</h2>
		<div class="bg-card flex justify-center rounded-lg border p-6">
			<FlipCard rotate="x">
				<div
