<script lang="ts">
	...
	let sourceUrl = $derived(`https://github.com/ramaherbin/fancy-ui/tree/main/src/lib/fancy-ui/${component.slug}`);
	...
	<section class="mb-10">
		...
		<div class="border-border overflow-hidden rounded-lg border">
			...
			{#if previewTab === "preview"}
				<div class="bg-background relative flex min-h-[300px] items-center justify-center overflow-hidden p-8">
	...
	<section class="mb-10">
		...
		<div class="flex flex-wrap gap-3">
			<a
				...
				class="border-border text-foreground inline-flex items-center gap-2 rounded-md border px-4 py-2 text-sm font-medium transition-colors hover:bg-accent"
			>
