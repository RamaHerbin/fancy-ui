// Editorial layout engine powered by @chenglou/pretext.
...
// carving → pretext line layout with cursor handoff across columns → DOM
// writes only (left/top/textContent). No DOM measurement anywhere in the
// render loop.
