 ...
 *
 * This file owns the data and the timers. `Toast.svelte` and `Toaster.svelte`
 ...
 * trap `_internals/id.ts`'s `uid()` guards against for the same reason.
 */
