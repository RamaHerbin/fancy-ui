...
| --------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--ft-dimsiblings-opacity`  | `0.4`   | Opacity of non-active siblings. Written inline only when `opacity` differs from the default, so a stylesheet rule can still set it otherwise.                                                                                                                                                  |
