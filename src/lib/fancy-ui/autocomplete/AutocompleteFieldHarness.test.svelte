<!--
  Test-only rig proving Autocomplete consumes the shared field context rather
...
<script lang="ts">
	...
	interface Props {
		...
		/**
		 * Autocomplete's own props, deliberately configurable rather than
...
<Autocomplete {suggestions} {id} {invalid} {required} {disabled} />
