 ...
 */
export function radialGradient(shape: 'circle' | 'ellipse', ...colors: string[]): string {
 ...
 */
export function getThemeGradient(startVar: string, endVar: string, angle: number = 135): string {
