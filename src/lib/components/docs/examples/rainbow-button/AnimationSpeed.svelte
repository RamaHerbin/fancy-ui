...
<div class="flex flex-wrap gap-4">
	<div class="flex flex-col items-center gap-2">
		<RainbowButton sound speed={1}>Fast (1s)</RainbowButton>
		<span class="text-muted-foreground text-xs">speed=1</span>
	</div>
	<div class="flex flex-col items-center gap-2">
		<RainbowButton sound speed={2}>Default (2s)</RainbowButton>
		<span class="text-muted-foreground text-xs">speed=2</span>
	</div>
	<div class="flex flex-col items-center gap-2">
		<RainbowButton sound speed={4}>Slow (4s)</RainbowButton>
