...
Ported from InspiraUI's AnimatedBeam component.
...
## Source
- Vue: `vendor/inspira/ui/animated-beam/AnimatedBeam.vue`
- Svelte: `src/lib/inspira/animated-beam/AnimatedBeam.svelte`
