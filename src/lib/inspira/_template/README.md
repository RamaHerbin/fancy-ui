...
This template provides the starting point for porting InspiraUI components to Svelte.

## Quick Start

```bash
# 1. Copy the template folder
cp -r src/lib/inspira/_template src/lib/inspira/[component-name]

# 2. Rename the component file
mv src/lib/inspira/[component-name]/Component.svelte \
   src/lib/inspira/[component-name]/[ComponentName].svelte

# 3. Update index.ts imports and exports

# 4. Add to src/lib/inspira/index.ts
```
...
2. Add to `src/lib/inspira/index.ts`:
   ```typescript
...
- [ ] All props from Vue version are supported
...
- [ ] README.md documents any differences from Vue version
