...
export default {
	...
	"intro.philosophy.card2.desc": "Chaque composant est livré avec des animations soignées prêtes à l'emploi.",
	...
	"intro.philosophy.card4.desc": "Stylisé avec des classes utilitaires et des propriétés CSS personnalisées.",
	"intro.philosophy.card5.title": "TypeScript",
	"intro.philosophy.card5.desc": "Sûreté de typage complète avec des interfaces de propriétés exportées.",
