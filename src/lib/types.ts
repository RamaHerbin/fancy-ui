/**
 * Shared component types for Inspira Svelte
 *
 * These types provide a consistent foundation for all ported components.
 */
...
/**
 * Base props shared by all Inspira components
 */
...
export interface ComponentMeta {
	...
	/** Dependencies on other inspira components */
	dependencies?: string[];
}
