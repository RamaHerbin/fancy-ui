...
![Components](https://img.shields.io/badge/Components-134-8B5CF6)
...
- **134 Components** &mdash; Core primitives (forms, navigation, overlays) alongside buttons, text animations, backgrounds and effects
