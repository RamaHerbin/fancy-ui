...
![Components](https://img.shields.io/badge/Components-145-8B5CF6)
...
- **145 Components** &mdash; Core primitives (forms, navigation, overlays) alongside buttons, text animations, backgrounds, effects and a micro-interactions collection
